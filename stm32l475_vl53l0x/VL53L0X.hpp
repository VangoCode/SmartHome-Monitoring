...
#ifndef VL53L0X_I2C_DRIVER_H
#define VL53L0X_I2C_DRIVER_H

#include "stm32l4xx_hal.h"
#include <cstdint>
#include <stdint.h>

// The actual device address for i2c
#define I2C_ADDRESS         0x52
// For i2c, the lsb is 0 for write, 1 for read
// The address to read and write from i2c
#define I2C_ADDRESS_READ    0x53
#define I2C_ADDRESS_WRITE   0x52

// Reference registers taken directly from datasheet
// initial value of register with address 0x... should be 0x...
#define register_0xC0 0xC0
#define register_0xC1 0xC1
#define register_0xC2 0xC2
#define register_0x51 0x51
#define register_0x61 0x61
#define initial_register_addr_0xC0 0xEE
#define initial_register_addr_0xC1 0xAA
#define initial_register_addr_0xC2 0x10
#define initial_register_addr_0x51 0x0099
#define initial_register_addr_0x61 0x0000


/*
 * DISTANCE DETECTION STRUCT
 */
typedef struct {
    /* I2C Handler */
    // type from HAL
...
/*
 * LOW LEVEL REGISTER FUNCTION DEFINITIONS
 */
